...
env$tab1
rsquared <- sapply(eval, function(x){mean(x$R2$est)}) %>% data.frame()
...
colnames(tab_pmm) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_blend.pmm.rank) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_blendhalf.rank) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_mahalan.rank) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_blend.pmm.scale) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_blendhalf.scale) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
...
colnames(tab_mahalan.scale) <- c("mech","mis", "dist", "cor", "qbar", "se", "t", "df", "b", "2.5%", "97.5%", "true", "cov", "bias")
