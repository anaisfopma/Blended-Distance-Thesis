...
source("Simulation conditions I/1.MAR_25_normal_0.R")
source("Simulation conditions I/2.MAR_25_normal_0.1.R")
source("Simulation conditions I/3.MAR_25_normal_0.7.R")
source("Simulation conditions I/4.MAR_25_skew_0.R")
source("Simulation conditions I/5.MAR_25_skew_0.1.R")
source("Simulation conditions I/6.MAR_25_skew_0.7.R")

# execute scripts for condition MARright with 25% missingness
source("Simulation conditions I/7.MAR_50_normal_0.R")
source("Simulation conditions I/8.MAR_50_normal_0.1.R")
source("Simulation conditions I/9.MAR_50_normal_0.7.R")
source("Simulation conditions I/10.MAR_50_skew_0.R")
source("Simulation conditions I/11.MAR_50_skew_0.1.R")
source("Simulation conditions I/12.MAR_50_skew_0.7.R")
